...
class ModelExtensionModuleStable extends Model {
	...
	public function refreshChatSession($chat) {
	...
	public function getCustomer($customer_id) {
		...
		if ($customer_query->num_rows) {
			return array(
				...
				'addresses'				  => $this->getAddresses($customer_query->row['customer_id']),
				'newsletter'       		  => $customer_query->row['newsletter'],
				'status'            	  => $customer_query->row['status'],
				'safed'            		  => $customer_query->row['safe'],
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id, CONCAT(o.firstname, ' ', o.lastname) AS customer_name, o.order_status_id, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS order_status, o.shipping_code, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified FROM `" . DB_PREFIX . "order` o";
